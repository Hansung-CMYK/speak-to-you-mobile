import 'package:ego/screens/egoreview/ego_model_review.dart';
...
/// egoInfoModel : 띄울 EGO의 정보 \[EgoModelV2]
void showTodayEgoModelIntroSheet(
        ...
        Container(
          ...
          child: ClipOval(
            child: widget.egoModelV2.profileImage != null
                ? Image.memory(widget.egoModelV2.profileImage!, fit: BoxFit.cover)
                : Image.asset('assets/image/ego_icon.png', fit: BoxFit.cover),
          ),
        ),
        Padding(
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          DateFormat('yyyy.MM.dd').format(widget.egoModelV2.createdAt!),
                          style: TextStyle(
                            height: 1.5.h,
                            fontSize: 14.sp,
